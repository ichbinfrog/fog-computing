...
main (int argc, char *argv[])
{
  ...
  topoReader.SetFileName ("scratch/grid-wifi-3-random-15-frontier/grid-wifi-3.txt");
  topoReader.Read ();
  ...
  ndnHelper.SetOldContentStore ("ns3::ndn::cs::Random", "MaxSize", "15");
  ...
  ndn::AppDelayTracer::InstallAll ("benchmark/out/app_grid_3layers_random_15_frontier.txt");
  ndn::CsTracer::InstallAll ("benchmark/out/cs_grid_3layers_random_15_frontier.txt", Seconds (1));
