...
main (int argc, char *argv[])
{
  ...
  topoReader.SetFileName ("scratch/grid-wifi-3-lru-15/grid-wifi-3.txt");
  topoReader.Read ();
  ...
  ndn::AppDelayTracer::InstallAll ("benchmark/out/app_grid_3layers_lru_15.txt");
  ndn::CsTracer::InstallAll ("benchmark/out/cs_grid_3layers_lru_15.txt", Seconds (1));
