...
main (int argc, char *argv[])
{
  ...
  topoReader.SetFileName ("scratch/grid-wifi-3-lru/grid-wifi-3.txt");
  topoReader.Read ();
  ...
  ndn::AppDelayTracer::InstallAll ("benchmark/out/app_grid_3layers_lru_2000.txt");
  ndn::CsTracer::InstallAll ("benchmark/out/cs_grid_3layers_lru_2000.txt", Seconds (1));
