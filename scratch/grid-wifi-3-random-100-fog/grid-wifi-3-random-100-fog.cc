...
main (int argc, char *argv[])
{
  ...
  ndn::AppDelayTracer::InstallAll ("benchmark/out/app_grid_3layers_random_100_fog.txt");
  ndn::CsTracer::InstallAll ("benchmark/out/cs_grid_3layers_random_100_fog.txt", Seconds (1));
