...
main (int argc, char *argv[])
{
  ...
  topoReader.SetFileName ("scratch/grid-wifi-4-fifo-15-frontier/grid-wifi-4.txt");
  topoReader.Read ();
  ...
  // Installs tracers
  ndn::AppDelayTracer::InstallAll ("benchmark/out/app_grid_4layers_fifo_15_frontier.txt");
  ndn::CsTracer::InstallAll ("benchmark/out/cs_grid_4layers_fifo_15_frontier.txt", Seconds (1));
