...
main (int argc, char *argv[])
{
  ...
  ndn::AppDelayTracer::InstallAll ("benchmark/out/app_grid_3layers_random_100.txt");
  ndn::CsTracer::InstallAll ("benchmark/out/cs_grid_3layers_random_100.txt", Seconds (1));
