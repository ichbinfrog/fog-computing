...
main (int argc, char *argv[])
{
  ...
  topoReader.SetFileName ("scratch/grid-wifi-3-lfu-15-frontier/grid-wifi-3.txt");
  topoReader.Read ();
  ...
  ndn::AppDelayTracer::InstallAll ("benchmark/out/app_grid_3layers_lfu_15_frontier.txt");
  ndn::CsTracer::InstallAll ("benchmark/out/cs_grid_3layers_lfu_15_frontier.txt", Seconds (1));
  Simulator::Run ();
  Simulator::Destroy ();
