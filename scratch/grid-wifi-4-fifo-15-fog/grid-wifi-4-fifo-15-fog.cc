...
main (int argc, char *argv[])
{
  ...
  // Installs tracers
  ndn::AppDelayTracer::InstallAll ("benchmark/out/app_grid_4layers_fifo_15_fogtxt");
  ndn::CsTracer::InstallAll ("benchmark/out/cs_grid_4layers_fifo_15_fog.txt", Seconds (1));
